...
use reticulum::transport::{BroadcastLink, Transport, TransportConfig};
use reticulum_core::destination::link::{Link, LinkEvent, LinkStatus};
...
async fn main() {
    ...
    let mut links = HashMap::<AddressHash, Arc<tokio::sync::Mutex<BroadcastLink>>>::new();
